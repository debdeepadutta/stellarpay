...
const WalletCard = ({ address, balance, isFetching }) => {
  return (
    <div className="w-full p-8 rounded-3xl glass card-gradient relative overflow-hidden">
      ...
      <div className="relative z-10 space-y-6">
        <div className="flex justify-between items-start">
          <div>
            ...
            <h3 className="text-xl md:text-2xl font-mono text-white break-all">{address || '---'}</h3>
          </div>
        ...
        <div className="pt-6 border-t border-white/5">
          ...
          <div className="flex items-baseline gap-2">
            {isFetching ? (
              ...
              <span className="text-5xl font-bold text-white tabular-nums">{balance || '0.00'}</span>
            )}
